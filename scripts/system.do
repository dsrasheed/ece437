...
add wave -noupdate -expand -group Exec_Stage /system_tb/DUT/CPU/DP/ESTAGE/aluif/ra
add wave -noupdate -expand -group Exec_Stage /system_tb/DUT/CPU/DP/ESTAGE/aluif/rb
add wave -noupdate -expand -group Exec_Stage /system_tb/DUT/CPU/DP/ESTAGE/aluif/out
add wave -noupdate -expand -group Exec_Stage /system_tb/DUT/CPU/DP/ESTAGE/aluif/negative
add wave -noupdate -expand -group Exec_Stage /system_tb/DUT/CPU/DP/ESTAGE/aluif/overflow
...
add wave -noupdate -expand -group reg_file /system_tb/DUT/CPU/DP/DSTAGE/reg_file/registers
