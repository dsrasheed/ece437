...
add wave -noupdate -color Gold /register_file_tb/PROG/expected_registers
add wave -noupdate /register_file_tb/rfif/rsel1
add wave -noupdate /register_file_tb/rfif/rdat1
add wave -noupdate -color Gold /register_file_tb/PROG/rdat1_success
add wave -noupdate /register_file_tb/rfif/rsel2
add wave -noupdate /register_file_tb/rfif/rdat2
add wave -noupdate -color Gold /register_file_tb/PROG/rdat2_success
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2720 ns} 0}
...
update
WaveRestoreZoom {1334 ns} {2804 ns}
